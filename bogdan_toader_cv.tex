...
\cventry{Jul 2019--Jul 2021}{Postdoctoral Research Associate}
...
\cventry{2015--2020}{PhD in Mathematics}
  ...
  \smallitem[0em]{\textit{Thesis title}}{Stability and perturbation analysis of non-negative super-resolution}%
...
\cventry{May--Jul 2016}
        ...
        \smallitem{\textit{Supervisors}}{
          ...
          Dr Peter Harris (NPL), Dr Stéphane Chrétien (NPL)
        }
...
\cvitem{Sep 2020}{
  \textit{Virtual 12th Light Sheet Fluorescence Microscopy Conference 2020} 
  -- oral presentation
}

\cvitem{Jul 2020}{
  \textit{SIAM Conference on Imaging Science (IS20)},
  online -- poster presentation
}

\cvitem{Jan 2020}{
  \textit{Quantitative BioImaging Conference (QBI 2020)},
  Oxford, UK -- poster presentation
}

\cvitem{Aug 2019}{
        \textit{International Conference 
          on Continuous Optimization (ICCOPT 2019)},
...
\cvitem{Jun 2018}{
        \textit{2018 IEEE Data Science Workshop (DSW 2018)}, 
...
\cvitem{Dec 2019}{
  ...
  Alan Turing Institute, London, UK \newline
  Implemented deep learning based solution for
  image segmentation applied to brighfield microscopy
  data.
}
...
\cventry{2020--2021}{Numerical Analysis}
        {University of Cambridge}{}{}
        {
          Supervisor for third year undergraduate students. Responsible with
          marking and running fortnightly supervisions for pairs of students 
          from a number of Cambridge colleges.
        }

\cventry{2016--2018}{Continuous Optimisation}
        {University of Oxford}{}{}
        {
          Teaching assistant for fourth year undergraduate course.
...
\cventry{2016--2018}{Integer Programming}
        {University of Oxford}{}{}
        {
          Teaching assistant for third year undergraduate course.
          Responsible with marking weekly assignments and solving
          problems on the board during classes, to groups
          of up to 15 students.
          Ran revision classes independently to groups of 30 students.
...
\cventry{2016--2017}{Computational Mathematics}
        {University of Oxford}{}{}
        {
          Lab demonstrator for first year undergraduate Matlab classes.
...
\cventry{2010--2011}{Peer Assisted Study Sessions Leader}
        ...
        {
          Weekly sessions with first year 
